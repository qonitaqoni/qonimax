...
<html>
<head>
<title>Cinema A Entertainment Category Flat Bootstrap Responsive Website Template | 404 :: w3layouts</title>
	...
	<div class="full">
			<div class="menu">
				<ul>
					...
					<li><a  class="active" href="<?php echo base_url(); ?>menu/voucher"><div class="bk"><i class="booking"></i><i class="booking1"></i></div></a></li>
		...
		<div class="error-content">
			...
			<div class="error-404 text-center">
				<h4>Masukkan No. Token</h4>
				<form>
				<input type="text"><br>
				<input type="submit" value="Submit" class="b-home">
				</form>
			</div>	
	<div class="footer">
		<div class="copyright">
